...
public class Board {
	...
	public Board(int bid, String btitle, String bcontent, Date createDate, Date modifyDate, int bcount, String status,
			...
			String profilePath, long price, List<Image> friendPhotoList, List<Answer> friendAnswerList) {
		super();
		this.bid = bid;
		this.btitle = btitle;
	...
	public String toString() {
		return "Board [bid=" + bid + ", btitle=" + btitle + ", bcontent=" + bcontent + ", createDate=" + createDate
				...
				+ nickname + ", profilePath=" + profilePath + ", price=" + price + ", friendPhotoList="
				+ friendPhotoList + ", friendAnswerList=" + friendAnswerList + "]";
	}
